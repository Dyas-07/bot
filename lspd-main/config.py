...
TICKET_CATEGORIES = [
    ...
    ("Recrutamentos", "Entrar em contacto com a equipa de recrutamentos.", "📋", int(os.getenv('TICKET_CATEGORY_GENERAL_CANDS')) if os.getenv('TICKET_CATEGORY_GENERAL_CANDS') else None),
